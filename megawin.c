...
{
	static const uint8_t query[] ={ 0x0C, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x32, 0x01, 0x00 };
...
{
	uint8_t query[20] ={ 0x13, 0x9C, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00 };
	static const uint8_t answer[]={ 0x01, 0x41 };
	uint8_t data[8];
